...
from industry_classification.main import run_batch
from industry_classification.rate_limit import RuntimeConfig
from industry_classification.sql_template import (
    load_sql_template,
    render_sql,
...
class BatchScheduler:
    ...
    def _run_single_day(self, pt: str, publish_start: str | None = None, publish_end: str | None = None, output_name: str | None = None) -> DayResult:
        ...
        from industry_classification.data_fetcher import fetch_by_sql
        ...
        if not wide_rows:
            ...
            # 仍然同步已有结果到 MC
            try:
                from industry_classification.writers.mc_writer import sync_to_mc
